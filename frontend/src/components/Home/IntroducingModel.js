                ...
                <div className="px-6 pt-20 pb-6 bg-zinc-100 rounded-2xl justify-start items-start gap-2.5 flex">
                  <div className="flex-col justify-start items-start gap-6 inline-flex">
                    <img
                      ...
                      src="https://via.placeholder.com/322x270" alt=''
                    />
            ...
            <div className="w-[770px] h-[922px] relative">
              ...
              <div className="left-[24px] top-[846px] absolute justify-start items-end gap-[276px] inline-flex">
                <div className="flex-col justify-start items-start gap-2 inline-flex">
                  ...
                  <div className="w-[322px] text-slate-500 text-sm font-normal font-['Rubik'] leading-[18px]">
                    Navy
                  </div>
                </div>
...
export default IntroducingModel